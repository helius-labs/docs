---
title: What is NFT compression on Solana?
description: >-
  The most cost-efficient way of minting large numbers of digital assets in
  crypto.
---
...
* A [DAS API](../digital-asset-standard-das-api/) call is required to read any information about a compressed NFT (e.g., attributes, collection information, etc.). This would affect Solana dApps loading your assets, etc.&#x20;
