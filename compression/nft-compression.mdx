...
* A [DAS API](/das-api) call is required to read any information about a compressed NFT (e.g., attributes, collection information, etc.). This would affect Solana dApps loading your assets, etc.&#x20;
