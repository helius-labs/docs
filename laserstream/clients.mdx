...
<Warning>
As Solana continues to scale, Yellowstone JavaScript clients will struggle to keep up. If Solana speeds up 3x, Yellowstone gRPC clients subscribing to all transactions or blocks will fail to match chain speed. LaserStream's performance headroom ensures your application scales with the network.
</Warning>
...
| Reconnection | ✅ Seamless | ⚠️ Basic support |
