...
Get your Helius API key from the [Helius Dashboard](https://dashboard.helius.dev/). LaserStream requires at least a Developer plan for devnet or Professional plan for mainnet access.
