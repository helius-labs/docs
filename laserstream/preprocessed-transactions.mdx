---
title: "Preprocessed Transaction Subscriptions (Beta)"
sidebarTitle: "Preprocessed Transactions (Beta)"
description: "Subscribe to transactions as they're decoded from shreds for ultra-low latency monitoring without transaction metadata."
---

<Warning>
**Beta Feature - Request Access Required**

Preprocessed transaction subscriptions are currently in beta. To request access, please contact the Helius team via [Telegram](https://t.me/helius_help) or [Discord](https://discord.gg/EqanqfQU).
</Warning>

Preprocessed transactions represent one of the fastest ways to receive transaction data from Solana. Instead of waiting for full transaction processing, LaserStream decodes transactions directly from shreds as they arrive at the validator, giving you access to transaction data milliseconds earlier than standard subscriptions.
