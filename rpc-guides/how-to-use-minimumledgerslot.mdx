---
title: "How to Use minimumLedgerSlot to Find the Oldest Available Slot"
description: "Learn to use the Solana minimumLedgerSlot RPC method to determine the lowest (oldest) slot the RPC node has in its ledger."
---
