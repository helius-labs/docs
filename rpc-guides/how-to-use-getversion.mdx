---
title: "How to Use getVersion to Check Node Software Version"
description: "Learn to use the Solana getVersion RPC method to retrieve the software version of the queried RPC node."
---
