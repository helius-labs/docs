---
title: "How to Use getStakeMinimumDelegation to Find Minimum Stake Delegation Amount"
description: "Learn to use the Solana getStakeMinimumDelegation RPC method to determine the minimum lamports required for a stake delegation."
---
...
*   **Dynamic Value:** The minimum delegation amount is subject to change by network parameters. It's advisable to query this value periodically or before critical operations rather than hardcoding it.
