---
title: "How to Use getSupply to Check SOL Tokenomics"
description: "Learn to use the Solana getSupply RPC method to retrieve current information about the total, circulating, and non-circulating SOL supply."
---
...
1.  **`commitment`** (string, optional): Specifies the [commitment level](https://docs.solana.com/developing/clients/jsonrpc-api#configuring-state-commitment) for the query. If omitted, the default commitment of the RPC node is used.
