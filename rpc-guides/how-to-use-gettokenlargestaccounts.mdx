---
title: "How to Use getTokenLargestAccounts to Find Top Token Holders"
description: "Learn to use the Solana getTokenLargestAccounts RPC method to retrieve the 20 largest token accounts for a specific SPL Token mint."
---

# How to Use `getTokenLargestAccounts`

The `getTokenLargestAccounts` RPC method returns a list of the 20 largest token accounts for a given SPL Token mint. This is useful for analyzing token distribution and identifying major holders of a particular token.
