---
title: "How to Use getSignaturesForAddress to Retrieve Transaction History"
description: "Learn how to use the Solana getSignaturesForAddress RPC method to fetch a list of transaction signatures for a specific account address."
---
...
*   **Account Transaction History:** Displaying the past transactions for a user's wallet.
