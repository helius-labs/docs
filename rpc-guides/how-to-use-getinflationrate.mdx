---
title: "How to Use getInflationRate for Current Epoch Inflation"
description: "Learn to use the Solana getInflationRate RPC method to retrieve the specific inflation breakdown (total, validator, foundation) for the current epoch."
---

# How to Use `getInflationRate` for Current Epoch Inflation

The `getInflationRate` RPC method returns a breakdown of the inflation rates for the current epoch. This includes the total inflation rate, the portion allocated to validators, the portion allocated to the foundation, and the epoch number these rates apply to.
