---
title: "How to Use getBlockTime to Estimate Block Production Time"
description: "Learn to use the Solana getBlockTime RPC method to retrieve the estimated production time of a specific block."
---

# How to Use `getBlockTime` to Estimate Block Production Time

The `getBlockTime` RPC method provides the estimated production time of a specified block, identified by its slot number. The time is returned as a Unix timestamp (seconds since the Unix epoch).
