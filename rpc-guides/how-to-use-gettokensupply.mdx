---
title: "How to Use getTokenSupply to Check Total Token Supply"
description: "Learn to use the Solana getTokenSupply RPC method to retrieve the total supply of a specific SPL Token."
---
