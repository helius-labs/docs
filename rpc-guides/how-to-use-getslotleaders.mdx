---
title: "How to Use getSlotLeaders to Find Upcoming Block Producers"
description: "Learn to use the Solana getSlotLeaders RPC method to retrieve a list of scheduled slot leaders for a given range of slots."
---
...
*   **Epoch Boundaries:** The leader schedule is determined for an entire epoch. This method allows you to query parts of that schedule. If your range crosses an epoch boundary, the leaders returned will still be based on the schedule of the epoch in which `startSlot` resides, up to the limit you provide or the end of that epoch's known schedule if the RPC node doesn't project further for that call.
