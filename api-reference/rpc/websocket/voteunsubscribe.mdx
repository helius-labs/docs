...
"og:title": "voteUnsubscribe Solana RPC Method"
sidebarTitle: "voteUnsubscribe"
description: "Unsubscribe from vote notifications."
"og:description": "Get a free RPC and explore the voteUnsubscribe RPC Method. Includes request parameters, response examples, code snippets, and in-browser testing for both Solana Mainnet and Devnet."
---
