---
title: 'Solana RPC Methods and API Reference'
sidebarTitle: 'Overview'
description: 'This page provides an overview of all available HTTP RPC methods that can be used to interact with Solana's RPC API.'
---
