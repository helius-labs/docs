---
title: 'Error Codes FAQ'
description: 'Troubleshoot HTTP error codes when using Helius RPC endpoints - identify and resolve the most common authentication, rate limiting, and server issues'
---
