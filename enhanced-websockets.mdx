...
<Tip>
For high-volume data streaming on Professional plans, [**Data Add-Ons**](/billing/plans) provide included monthly data allowances (5TB-100TB) for predictable costs. Data Add-Ons apply to both LaserStream and Enhanced WebSockets usage.
</Tip>
