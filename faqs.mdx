...
<CardGroup cols={2}>
  ...
  <Card title="Dashboard" icon="gauge" href="/faqs/dashboard">
    Project management, account settings, and usage monitoring
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Archival" icon="box-archive" href="/faqs/archival">
    Archival data access, historical information, and data retention
  </Card>
</CardGroup>
