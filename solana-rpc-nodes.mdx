...
<Card title="Learn more about Shared Nodes" icon="arrow-right" href="/solana-rpc-nodes/shared-nodes">
  Get more details about our Shared Nodes.
</Card>

### Dedicated Nodes

Dedicated nodes provide a private, exclusive RPC environment for your project. These nodes are ideal for high-volume applications, projects requiring consistent performance guarantees, or teams with specific regulatory requirements.
