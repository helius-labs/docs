...
<Tabs>
  <Tab title="When Someone Buys BONK (Big Trade)">
    ...
    **Backrun searcher's strategy**:
    ...
    - Capture the price difference as profit (with Helius rebates you earn from this profit)
...
<Note>
**Why This Helps Everyone**: Backrunning creates efficient price discovery and reduces slippage for future traders. Instead of letting this value go to random searchers, Helius lets you earn from the arbitrage opportunities your own trades create.
</Note>
