...
Backrunning is a **beneficial form of arbitrage** that helps keep prices consistent across different exchanges. Unlike malicious MEV attacks, backrunning actually **improves the network** by correcting price imbalances created by large trades.
...
<Tabs>
  ...
  <Tab title="When Someone Sells BONK (Big Trade)">
    ...
    **Result**: The price difference disappears, stabilizing the market
  </Tab>
</Tabs>
