...
<CardGroup cols={1}>
  <Card
    title="Transaction Rebates"
    icon="coins"
    href="/sending-transactions/backrun-rebates"
  >
    Earn automatic SOL rebates via post-trade backruns while protecting against toxic MEV. One parameter addition to your sendTransaction calls.
  </Card>
</CardGroup>
