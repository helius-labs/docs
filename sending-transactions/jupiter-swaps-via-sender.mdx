...
<Steps>
  ...
  <Step title="Configuration">
    Replace the hardcoded API key and private key with your credentials. Set the right constants for your swap: token addresses, amount, slippage. Choose the Sender enpoint that's closest to your server (it's currently set to EWR).
  </Step>
...
[Example transaction](https://solscan.io/tx/2weWhhYyGA9xPqFaXVfR9FdBDAjM3AEbebYzEER2bLQn6JJ7tJ8wwtncbvD9qi2xFJuDxHdDGQWQWQ7m1cUCg74S)

## Advanced

### Dynamic tipping using the Jito API

Right now, the tip amount is hardcoded at the minimum 0.001 SOL. However, this may not be enough to win the Jito auction for highly contested accounts. For these cases, use the Jito API to dynamically compute the Sender tip:
