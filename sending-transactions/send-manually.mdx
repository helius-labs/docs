---
title: "Sending Transactions Manually"
description: "The recommended, step-by-step guide for building a robust, production-grade transaction sending workflow on Solana."
---
...
<Info>
  The Helius SDKs are open-source. You can view the underlying code for the `sendSmartTransaction` method in our [Node.js SDK](https://github.com/helius-labs/helius-sdk.ts) and [Rust SDK](https://github.com/helius-labs/helius-sdk.rs) to see a production-grade implementation of this workflow.
</Info>
