...
Ready to submit your first ultra-low latency transaction? This guide will get you started with Helius Sender in minutes. The best part: **you don't need any paid plan or special access** - Sender is available to all users and doesn't consume API credits.
...
<Steps titleSize="h3">
  ...
  <Step title="Get Your API Key">
    Navigate to the [API Keys](https://dashboard.helius.dev/api-keys) section and copy your key. You'll use this for getting blockhashes and transaction confirmation, while Sender handles the ultra-fast submission.
  </Step>
