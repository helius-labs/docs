...
<CardGroup cols={2}>
  <Card title="Serialized Transaction (Recommended)" href="/sending-transactions/priority-fees/estimating-fees-using-serialized-transaction">
    Provide a fully serialized transaction for the most accurate fee estimates tailored to your specific transaction.
  </Card>
  <Card title="Account Keys" href="/sending-transactions/priority-fees/estimating-fees-using-account-keys">
