...
The same as **createStakeTransaction**, except it _only_ returns the `TransactionInstruction[]`. This is useful inside browser wallets that construct their own transaction object, or pairing with the SDK's [smart transactions](/sending-transactions/smart-transactions)
