...
description: 'Optimize your Solana transactions for maximum success rates and minimal latency'
---

## Transaction Best Practices

This guide covers recommended practices for sending transactions on Solana using Helius to maximize confirmation rates and minimize latency.
...
- Set up [Smart Transactions](/sending-transactions/smart-transactions) for your application
- Explore [Staked Connections](/sending-transactions/staked-connections) in depth
- Get started quickly with our [Quickstart Guide](/sending-transactions/quickstart) 