...
## Introduction to Priority Fees

Priority fees allow you to increase the likelihood of your Solana transactions being processed quickly by paying an additional fee. This enables your transactions to compete more effectively for block space during network congestion.
