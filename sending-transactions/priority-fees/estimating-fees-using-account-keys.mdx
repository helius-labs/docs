...
The account keys method is less accurate for read-only accounts. For the most accurate estimates, consider using the [serialized transaction method](/sending-transactions/estimating-fees-with-serialized-transaction) when possible.
</Callout>
...
- [Estimating Fees with Serialized Transactions](/sending-transactions/estimating-fees-with-serialized-transaction) 