...
**4.1.1 Single or Batched Transactions (**[**`/v0/transactions`**](/enhanced-transactions-api/gettransactions)**)**
...
**4.1.2 Parsed Transactions by Address (**[**`/v0/addresses/{address}/transactions`**](/enhanced-transactions-api/gettransactionsbyaddress)**)**
