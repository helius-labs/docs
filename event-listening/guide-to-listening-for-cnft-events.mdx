...
[**Enhanced WebSockets**](/data-streaming/laserstream-enhanced-websocket)
...
[**gRPC**](../../data-streaming/yellowstone-grpc-geyser.mdx) is the most flexible and high-performance event listening solution, available on [**Dedicated Nodes**](/solana-rpc-nodes/dedicated-nodes).
...
**4.1.1 Single or Batched Transactions (**[**`/v0/transactions`**](/enriched-transactions-api/getenrichedtransactions)**)**
