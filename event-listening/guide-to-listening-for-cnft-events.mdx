...
[**gRPC**](/data-streaming/yellowstone-grpc-geyser) is the most flexible and high-performance event listening solution, available on [**Dedicated Nodes**](/solana-rpc-nodes/dedicated-nodes).
...
**4.1.2 Parsed Transaction History by Address (**[**`/v0/addresses/{address}/transactions`**](/enriched-transactions-api/getenrichedtransactions)**)**
