---
title: Guide to listening for cNFT Events
description: Learn how to listen for and retrieve cNFT events on Solana using Helius APIs.
---
...
[**Enhanced WebSockets**](../../data-streaming/enhanced-websockets-beta.md)
...
[**Webhooks**](../../data-streaming/webhooks/) let Helius notify your server via HTTP POST whenever an on-chain event occurs. Ideal if you **don't want** a persistent connection.

1. **Create** the webhook via [API](../../data-streaming/webhooks/#via-helius-api), [SDK](../../data-streaming/webhooks/#via-helius-sdk) or [Dashboard](../../data-streaming/webhooks/#via-helius-dashboard).
...
[**gRPC**](../../data-streaming/yellowstone-grpc.md) is the most flexible and high-performance event listening solution, available on [**Dedicated Nodes**](../../solana-rpc-nodes/dedicated-nodes/).
...
**4.1.1 Single or Batched Transactions (**[**`/v0/transactions`**](../../solana-apis/enhanced-transactions-api/parse-transaction-s.md)**)**
...
**4.1.2 Parsed Transaction History by Address (**[**`/v0/addresses/{address}/transactions`**](../../solana-apis/enhanced-transactions-api/parsed-transaction-history.md)**)**
