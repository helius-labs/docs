...
For a detailed list of supported events, please refer to our [documentation](../../resources/transaction-types.md).
...
<Frame>
  <img src="../../.gitbook/assets/image (15).png" alt="Configuring a Webhook" />
  <figcaption>Configuring a Webhook</figcaption>
</Frame>
