...
title: Helius 速率限制
sidebarTitle: 速率限制
description: Helius 各计划和产品的速率限制完整指南。
---
...
您的计划有两个标准速率限制组：一个用于 RPC 请求，一个用于 DAS API 请求。以下是每个 Helius 计划的基本速率限制：
...
### 增加速率限制
专业计划的团队可以以每月 100 美元的价格购买额外的 100 RPS。
...
如果您处于专业计划并需要增加您的`sendTransaction`速率限制，请[联系我们的销售团队](https://form.typeform.com/to/KiacmxpZ)。
