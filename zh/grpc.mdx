...
<Tabs>
  <Tab title="账户">
    **实时监控账户变化**
    ...
    <Card title="账户监控指南" icon="user" href="/grpc/account-monitoring">
      学习如何通过过滤示例流式传输账户更新
    </Card>
  </Tab>
  ...
  <Tab title="交易">
    **流式传输交易数据和执行结果**
    ...
    <Card title="交易监控指南" icon="receipt" href="/grpc/transaction-monitoring">
      通过程序过滤和执行细节监控交易
    </Card>
  </Tab>
  ...
  <Tab title="槽和区块">
    **跟踪网络共识和区块生成**
    ...
    <Card title="槽和区块监控指南" icon="cube" href="/grpc/slot-and-block-monitoring">
      流式传输包含交易详情的槽和区块
    </Card>
  </Tab>
  ...
  <Tab title="条目">
    **低级别区块链条目监控**
    ...
    <Card title="条目监控指南" icon="code" href="/grpc/entry-monitoring">
      流式传输包含交易批次的区块条目
    </Card>
  </Tab>
</Tabs>
...
**[LaserStream](/laserstream/)** - 多租户、高可用的 gRPC 服务，具有自动故障切换和历史回放功能。非常适合大多数生产应用程序。

**[Dedicated Nodes](/dedicated-nodes/)** - 独享的 gRPC 端点，提供资源隔离保障。最适合特殊需求。

**需要帮助选择？** 查看我们的[详细比较指南](/laserstream/laserstream-vs-dedicated-nodes)，了解哪种选项适合您的使用场景。
</Note>
...
<Card title="Yellowstone gRPC 快速入门" icon="rocket" href="/grpc/quickstart">
...
<CardGroup cols={2}>
  <Card title="完整设置指南" icon="rocket" href="/grpc/quickstart">
    安装、认证和首次流实现
  </Card>
  <Card title="流式监控 Pump AMM 数据" icon="chart-line" href="/grpc/stream-pump-amm-data">
    实际示例：监控 Pump AMM 交易
  </Card>
</CardGroup>
...
- **[LaserStream 文档](/laserstream/)** - 提供额外功能的增强型 gRPC 服务
