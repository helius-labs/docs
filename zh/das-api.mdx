...
<Tabs>
  ...
  <Tab title="getAssetBatch">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/getassetbatch">
  ...
  <Tab title="getAssetProof">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/getassetproof">
  ...
  <Tab title="getAssetProofBatch">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/getassetproofbatch">
...
<Tabs>
  <Tab title="按所有者">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/getassetsbyowner">
  ...
  <Tab title="按集合">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/getassetsbygroup">
  ...
  <Tab title="按创建者">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/getassetsbycreator">
  ...
  <Tab title="按权限">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/getassetsbyauthority">
...
<Tabs>
  <Tab title="searchAssets">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/searchassets">
  ...
  <Tab title="getSignaturesForAsset">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/getsignaturesforasset">
  ...
  <Tab title="getNftEditions">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/getnfteditions">
  ...
  <Tab title="getTokenAccounts">
    ...
    <Card title="API 参考" horizontal icon="code" href="/api-reference/das/gettokenaccounts">
