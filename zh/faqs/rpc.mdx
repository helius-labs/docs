...
<Accordion title="为什么在计划的速率限制以下，我的 getProgramAccounts 会被限速？">
...
使用 `getLatestBlockhash` 和 `"confirmed"` 承诺级别来获取最新的 blockhash。在提交交易之前，始终获取新的 blockhash 以确保有效性。详情请参阅我们的 [getLatestBlockhash 指南](/zh/rpc/guides/getlatestblockhash)。
</Accordion>
