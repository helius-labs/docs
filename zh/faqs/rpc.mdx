...
使用 `getLatestBlockhash` 与 `"processed"` 或 `"confirmed"` 承诺级别获取最新的 blockhash。在提交交易之前始终获取新的 blockhash 以确保有效性。详情请参阅我们的[getLatestBlockhash 指南](/zh/rpc/guides/getlatestblockhash)。
</Accordion>
