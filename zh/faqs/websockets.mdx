...
3. **使用适当的连接管理**：遵循我们[增强型 WebSockets 文档](/enhanced-websockets/transaction-subscribe)中显示的模式
...
**对于标准 WebSockets**，根据您的监控需求使用 `logsSubscribe` 或 `signatureSubscribe` 方法。有关每种订阅类型的详细示例，请参阅我们的 [WebSocket 指南](/rpc/websocket)。
</Accordion>
