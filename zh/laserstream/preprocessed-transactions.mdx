...
description: 流式传输Solana交易的最快方式。
---

<Warning>
**测试版功能 - 需要请求访问权限**

预处理交易目前处于测试阶段。要请求访问权限，请通过[Telegram](https://t.me/helius_help)或[Discord](https://discord.gg/EqanqfQU)联系Helius团队。
</Warning>

预处理交易是接收Solana交易的最快方式。LaserStream直接从分片中解码交易，而不是等待完整的交易处理，这使您比标准订阅提前几毫秒获取交易数据。
