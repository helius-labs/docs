...
<CardGroup cols={2}>
  <Card title="序列化交易（推荐）" icon="file-code" href="/priority-fee/estimating-fees-using-serialized-transaction">
  ...
  <Card title="账户密钥（高级）" icon="key" href="/priority-fee/estimating-fees-using-account-keys">
    **特殊用例** - 基于账户模式的估算
...
您可以使用 Solana 浏览器或 `getRecentPerformanceSamples` RPC 方法检查当前网络状况。
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="直接支持" icon="headset" href="/support">
    优先费用问题和优化协助
  </Card>
</CardGroup>
