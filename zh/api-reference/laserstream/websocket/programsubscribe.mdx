...
description: 订阅一个程序，以便在给定程序拥有的账户的 lamports 或数据发生变化时接收通知。
---

## 端点

主网和开发网上提供 Websockets，使用以下 URL：
    ...
    <Expandable title="properties" defaultOpen>
        ...
        <ParamField body="config" type="object">
            ...
            <ParamField body="encoding" type="string">
                ...
                - `base58`速度较慢
                - `jsonParsed`编码尝试使用特定于程序的状态解析器返回更具可读性和明确的账户状态数据
...
通知格式是一个**单一**程序账户对象，如在`getProgramAccounts` RPC HTTP方法中所示。
