...
<CardGroup cols={2}>
  <Card title="账户密钥方法" icon="key" href="/zh/priority-fee/estimating-fees-using-account-keys">
    使用账户密钥的高级方法，适用于特殊用例
  </Card>
  <Card title="API 参考" icon="book" href="/zh/api-reference/priority-fee/getpriorityfeeestimate">
    完整的 API 文档和参数
  </Card>
</CardGroup>