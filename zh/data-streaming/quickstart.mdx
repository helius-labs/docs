...
<Card title="标准 WebSockets 指南" icon="arrow-right" href="/rpc/websocket">
  完整参考，包含所有订阅方法和示例
</Card>
...
<Card title="增强型 WebSockets 指南" icon="arrow-right" href="/enhanced-websockets">
  学习高级过滤和订阅选项
</Card>
...
<Card title="LaserStream 指南" icon="arrow-right" href="/laserstream">
...
<Card title="Webhooks 指南" icon="arrow-right" href="/webhooks">
  完整的 webhook 设置和事件处理
</Card>
