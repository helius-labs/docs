...
解析交易端点将原始交易签名或数据转换为结构化的、人类可读的信息。您无需手动解码指令数据和账户列表，即可获得关于转账、交换、NFT活动等的清晰细节。
...
有关增强型交易的常见问题，包括使用、认证、速率限制和故障排除，请访问我们的综合[增强型交易FAQ](/zh/faqs/enhanced-transactions)。
