...
<Tip>
**尝试 `getTransactionsForAddress`**：我们的新方法 [`getTransactionsForAddress`](https://www.helius.dev/docs/rpc/gettransactionsforaddress) 将 `getSignaturesForAddress` 和 `getTransaction` 合并为一个调用，并包含强大的新功能，包括反向搜索、基于时间的过滤器、代币账户历史和高效的分页。
</Tip>
