...
[`getTokenLargestAccounts`](https://www.helius.dev/docs/api-reference/rpc/http/gettokenlargestaccounts) RPC 方法返回给定 SPL Token 铸币的 20 个最大代币账户的列表。这对于分析代币分布和识别特定代币的主要持有者非常有用。
...
本指南帮助您使用 `getTokenLargestAccounts` RPC 方法发现 Solana 上任何 SPL 代币的主要持有者。