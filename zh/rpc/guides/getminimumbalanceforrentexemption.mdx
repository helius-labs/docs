...
[`getMinimumBalanceForRentExemption`](https://www.helius.dev/docs/api-reference/rpc/http/getminimumbalanceforrentexemption) RPC 方法允许您计算特定数据大小的账户成为免租金所需的最低 lamport 余额。
