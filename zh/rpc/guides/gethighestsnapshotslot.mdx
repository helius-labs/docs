...
[`getHighestSnapshotSlot`](https://www.helius.dev/docs/api-reference/rpc/http/gethighestsnapshotslot) RPC 方法返回有关查询的 Solana 节点具有分类帐快照的最高槽位的信息。这包括最新的完整快照槽位，以及（如果可用）基于该完整快照的最新增量快照槽位。
