...
*   **Token-2022（代币扩展）：** 如果你正在使用Token-2022程序创建的代币（支持转账费用、利息等扩展），请确保使用正确的`programId`：`TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb`。

本指南提供了对`getTokenAccountsByOwner` RPC方法的全面理解，使你能够高效地检索任何Solana地址的代币账户信息。
