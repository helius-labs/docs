...
[`getSupply`](https://www.helius.dev/docs/api-reference/rpc/http/getsupply) RPC 方法提供关于 Solana 网络上当前 SOL 供应的信息。它详细说明了总供应量、流通供应量、非流通供应量，并可以选择列出非流通账户。
...
*   **Lamports vs. SOL：** 金额以 lamports 返回。记得除以`1,000,000,000`（1 SOL = 10^9 lamports）以转换为 SOL。
