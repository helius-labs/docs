...
<CardGroup cols={2}>
  <Card title="立即开始构建" icon="rocket" href="#getting-your-rpc-url">
    获取您的 RPC 端点并发出您的第一个请求
  </Card>
  <Card title="浏览 RPC 方法" icon="book-open" href="/rpc/guides/overview">
...
<Card title="了解更多关于专用节点的信息" icon="server" href="/dedicated-nodes">
...
<CardGroup cols={2}>
  <Card title="优化性能" icon="rocket" href="/rpc/optimization-techniques">
    学习高级技术以最大化RPC性能并最小化成本
  </Card>
  <Card title="实时数据" icon="wifi" href="/data-streaming">
    为实时区块链事件设置流
  </Card>
</CardGroup>
