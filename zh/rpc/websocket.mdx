...
<Card title="完整的 API 参考" icon="book" href="/api-reference/rpc/websocket-methods">
...
对于需要更高级功能的应用程序，请考虑使用[LaserStream gRPC](/laserstream)：
...
<Note>
**准备好开始了吗？** 查看我们的[WebSocket快速入门指南](/rpc/websocket/quickstart)，获取实用示例和分步实施指南。
</Note>
