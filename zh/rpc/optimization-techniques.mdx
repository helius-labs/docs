...
<CardGroup cols={2}>
  <Card title="交易优化" icon="bolt" href="#transaction-optimization">
    优化计算单元、优先费用和交易发送
  </Card>
  <Card title="数据检索" icon="database" href="#data-retrieval-optimization">
    高效获取账户和程序数据的模式
  </Card>
  <Card title="实时监控" icon="chart-line" href="#real-time-monitoring">
    WebSocket 订阅和流数据优化
  </Card>
...
<Card title="⚡ 性能提升" icon="rocket" color="#E84125">
  `getProgramAccountsV2` 和 `getTokenAccountsByOwnerV2` 为处理大型数据集的应用程序提供了显著的性能改进：
...
<Card title="下一步" icon="arrow-right">
  准备好实施这些优化了吗？查看我们的[交易优化指南](/sending-transactions/optimizing-transactions)以获取交易特定的最佳实践。
</Card>
