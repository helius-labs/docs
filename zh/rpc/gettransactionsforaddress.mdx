...
<Tip>
**Helius 独家功能** - `getTransactionsForAddress` 仅通过 Helius RPC 节点提供，并不是标准 Solana RPC 的一部分。此端点需要 [开发者计划](/zh/billing/plans) 或更高级别，并且每个请求消耗 100 个积分。返回 100 个完整交易或 1,000 个签名。
</Tip>
