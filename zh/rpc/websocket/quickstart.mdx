...
<Card title="完整的 WebSocket API 参考" icon="book" href="/api-reference/rpc/websocket-methods">
...
<CardGroup cols={2}>
  <Card title="WebSocket 概述" icon="book" href="/rpc/websocket">
    了解 WebSocket 概念、承诺级别和高级重连模式
  </Card>
  <Card title="增强型 WebSockets" icon="signal-stream" href="/enhanced-websockets">
    探索具有附加功能和更好过滤的 Helius 增强型 WebSockets
  </Card>
  <Card title="LaserStream" icon="bolt" href="/laserstream">
    升级到 LaserStream 以实现超高速数据流和历史重播
  </Card>
  <Card title="API 参考" icon="code" href="/api-reference/rpc/websocket-methods">
