...
<Card title="getPriorityFeeEstimate" href="/api-reference/priority-fee/getpriorityfeeestimate">
...
<CardGroup cols={2}>
  <Card title="Serialized Transaction (Recommended)" href="/priority-fee/estimating-fees-using-serialized-transaction">
    Provide a fully serialized transaction for the most accurate fee estimates tailored to your specific transaction.
  </Card>
  <Card title="Account Keys" href="/priority-fee/estimating-fees-using-account-keys">
