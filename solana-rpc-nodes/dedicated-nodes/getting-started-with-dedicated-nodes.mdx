...
Here we are using Solana web3.js to call [`getSlot`](../../rpc/http/getslot.md) using our dedicated node:
...
* Avoid mixing heavy account-based calls (e.g. [getProgramAccounts](../../rpc/http/getprogramaccounts.md), [getTokenAccountsByOwner](../../rpc/http/gettokenaccountsbyowner.md), etc.) with gRPC usage on the same node.
