...
- Geyser Plugin (Optional) — [Yellowstone](/data-streaming/yellowstone-grpc-geyser.mdx)
...
<Note>
  ...
  [`sendTransaction`](/rpc/http/sendtransaction.mdx)).
</Note>
...
<Warning>
  ...
  Solana](/sending-transactions/staked-connections.mdx).
</Warning>
...
If you plan to make resource-intensive calls (e.g., [`getProgramAccounts`](/rpc/http/getprogramaccounts.mdx), [`getTokenLargestAccounts`](/rpc/http/gettokenlargestaccounts.mdx), [`getTokenAccountsByDelegate`](/rpc/http/gettokenaccountsbydelegate.mdx), [`getTokenAccountsByOwner`](/rpc/http/gettokenaccountsbyowner.mdx), [`getLargestAccounts`](/rpc/http/getlargestaccounts.mdx)), the AMD EPYC 7543p and AMD EPYC 9254 offer similar performance, but the EPYC 9254 is newer and more efficient.
...
Add optional features like the [Yellowstone](https://github.com/helius-labs/yellowstone-grpc) Geyser Plugin, which supports [streaming](/data-streaming/yellowstone-grpc-geyser.mdx) of slots, blocks, transactions, and account updates.
