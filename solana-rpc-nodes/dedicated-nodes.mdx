...
If you plan to make resource-intensive calls (e.g., [`getProgramAccounts`](/rpc/http/getprogramaccounts), [`getTokenLargestAccounts`](/rpc/http/gettokenlargestaccounts), [`getTokenAccountsByDelegate`](/rpc/http/gettokenaccountsbydelegate), [`getTokenAccountsByOwner`](/rpc/http/gettokenaccountsbyowner), [`getLargestAccounts`](/rpc/http/getlargestaccounts)), the AMD EPYC 7543p and AMD EPYC 9254 offer similar performance, but the EPYC 9254 is newer and more efficient.
...
Add optional features like the [Yellowstone](https://github.com/helius-labs/yellowstone-grpc) Geyser Plugin, which supports [streaming](/data-streaming/yellowstone-grpc-geyser) of slots, blocks, transactions, and account updates.
