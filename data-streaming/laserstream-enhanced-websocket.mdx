---
title: LaserStream Enhanced WebSocket
sidebarTitle: Enhanced WebSocket
...
If you need information on Atlas Enhanced WebSockets, please see our [Disclaimer](enhanced-websocket.md#disclaimer-transition-from-atlas-enhanced-websockets).
</Note>
