...
- [Enhanced WebSockets](/data-streaming/laserstream-enhanced-websockets) - Faster WebSockets with additional subscription methods
- [gRPC Streaming](/data-streaming/laserstream-grpc) - High-performance binary protocol for backend applications

For a complete reference of all WebSocket methods, see the [WebSocket documentation](/data-streaming/websocket). 