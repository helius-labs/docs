...
The Helius extension for fungible tokens resolves around ownership indexing. The following queries provide a unified view of an account's assets. [GetAsset](../das-api/getasset.mdx), [GetAssetsByOwner](../das-api/getassetsbyowner.mdx), and [SearchAssets](../das-api/searchassets.mdx) support fungible tokens.
