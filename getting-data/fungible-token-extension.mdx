...
The Helius extension for fungible tokens resolves around ownership indexing. The following queries provide a unified view of an account's assets. [GetAsset](../das-api/getasset), [GetAssetsByOwner](../das-api/getassetsbyowner), and [SearchAssets](../das-api/searchassets) support fungible tokens.
