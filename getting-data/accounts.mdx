...
<Card title="API Reference" horizontal icon="code" href="/rpc/http/getaccountinfo">
  getAccountInfo
</Card>
...
<Card title="API Reference" horizontal icon="code" href="/rpc/http/getmultipleaccounts">
  getMultipleAccounts
</Card>
