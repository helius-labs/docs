---
title: "Solana Fungible Token API: Complete Token Data Access"
sidebarTitle: 'Fungible Token Extension'
description: "The most versatile API for working with all Solana tokens. SPL tokens, Token22 extensions, price data, and comprehensive token information access."
---
