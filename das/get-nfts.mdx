---
title: "How to Get Solana Assets: NFTs, Tokens & Price Data"
sidebarTitle: 'Get Assets'
description: "Learn how to retrieve and query Solana NFTs, SPL tokens, and price data using Helius DAS APIs. Complete guide with code examples and best practices."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Token Pricing" icon="chart-line" href="#price-data-for-tokens">
    Access real-time price data for the top 100k tokens by 24h volume
  </Card>
...
For frequently asked questions about the DAS API including asset data, price information, and API usage, visit our comprehensive [DAS API FAQ](/faqs/das-api).
