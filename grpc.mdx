...
<Note>
gRPC is only available for dedicated nodes. You can provision a dedicated node directly from the [Dashboard](https://dashboard.helius.dev/dedicated-nodes). To learn more, please visit [dedicated-nodes](/dedicated-nodes/).
</Note>
