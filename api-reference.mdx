...
<CardGroup cols={2}>
  <Card title="HTTP Methods" icon="server" href="/rpc/http-methods">
    Land transactions effectively, query blockchain data instantly, and benefit from enhanced reliability and performance.
  </Card>
  <Card title="WebSocket Methods" icon="signal-stream" href="/rpc/websocket-methods">
...
<CardGroup cols={2}>
  ...
  <Card title="Enhanced Transactions" icon="receipt" href="/enhanced-transactions-api">
...
<CardGroup cols={2}>
  <Card title="LaserStream gRPC" icon="bolt" href="/laserstream-grpc-api">
  ...
  <Card title="LaserStream Enhanced WebSockets" icon="signal-stream" href="/laserstream-enhanced-websockets-api">
    Enhanced WebSockets expand on the standard WebSockets with two new methods: transactionSubscribe and accountSubscribe.
  </Card>
</CardGroup>

<CardGroup cols={1}>
  <Card title="Webhooks" icon="webhook" href="/webhooks-api">
