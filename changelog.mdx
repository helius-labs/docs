...
We're constantly working to improve your developer experience and provide you with the best Solana infrastructure.
...
<Update label="2024-05-29" description="Staked Transactions Default" tags={["API", "Pricing", "Infrastructure"]}>

### Staked Connections Are the New Default
