...
description: "AI-powered rewards forecasting with multiple models, confidence intervals, and scenario projections"
---
...
Generate intelligent rewards forecasts based on historical performance data using advanced statistical models. The API provides three scenario projections (conservative, baseline, optimistic) with confidence intervals and detailed methodology information.

### Forecasting Models

<CardGroup cols={2}>
  <Card title="Rolling Average" icon="chart-simple">
    Uses mean ± standard deviation from historical data based on the Dune methodology.
  </Card>
