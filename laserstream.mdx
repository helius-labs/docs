...
<Note>
**Plan Requirement**: LaserStream is available for **Professional plan** subscribers ($999/month). Professional plan users pay 3 credits per 0.1 MB for all LaserStream usage. You can upgrade your plan in the [Helius Dashboard](https://dashboard.helius.dev/).
</Note>
