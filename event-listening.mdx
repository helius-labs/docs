---
title: "Solana Event Listening: Real-Time Blockchain Monitoring"
sidebarTitle: Overview
description: "Monitor Solana blockchain events in real-time with webhooks, websockets and gRPC. Get instant notifications for transactions, account changes, and on-chain activity."
---
...
For common questions about implementation, check our [Webhooks FAQ](faqs/webhooks) or [Websockets FAQ](/faqs/websockets).
