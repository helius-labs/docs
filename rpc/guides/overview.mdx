...
description: "Learn how to use Solana RPC methods for querying live blockchain data, historical data, and sending transactions with these code snippets and best practices."
---
