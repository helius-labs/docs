---
title: "How to Use getVoteAccounts to Get Validator Voting Information"
description: "Learn to use the Solana getVoteAccounts RPC method to retrieve information about current and delinquent voting accounts (validators)."
---
...
1.  **`commitment`** (string, optional): Specifies the [commitment level](https://docs.solana.com/developing/clients/jsonrpc-api#configuring-state-commitment) for the query (e.g., `"finalized"`, `"confirmed"`, `"processed"`). If omitted, the node's default commitment is used.
