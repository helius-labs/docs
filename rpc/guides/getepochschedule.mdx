---
title: "How to Use getEpochSchedule"
description: "Learn getEpochSchedule use cases, code examples, request parameters, response structure, and tips."
---

The [`getEpochSchedule`](https://www.helius.dev/docs/api-reference/rpc/http/getepochschedule) RPC method returns the epoch schedule information from the cluster's genesis configuration. This data defines how epochs are structured, including their length and how the leader schedule is determined relative to an epoch's start. For a general overview of epochs in Solana, see our article on [Understanding Slots, Blocks, and Epochs on Solana](https://www.helius.dev/blog/solana-slots-blocks-and-epochs).
