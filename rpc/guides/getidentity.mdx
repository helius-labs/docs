---
title: "How to Use getIdentity to Get Node's Public Key"
description: "Learn to use the Solana getIdentity RPC method to retrieve the public key (identity) of the connected RPC node."
---

# How to Use `getIdentity` to Get Node's Public Key
