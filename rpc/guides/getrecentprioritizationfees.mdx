---
title: "How to Use getRecentPrioritizationFees for Optimal Transaction Fees"
description: "Learn to use the Solana getRecentPrioritizationFees RPC method to fetch recent priority fee data, helping you set competitive fees for your transactions."
---
