---
title: "How to Use getRecentPerformanceSamples"
description: "Learn getRecentPerformanceSamples use cases, code examples, request parameters, response structure, and tips."
---
