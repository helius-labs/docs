...
description: "Learn getAccountInfo use cases, code examples, request parameters, response structure, and tips."
---
...
2.  `config` (object, optional): A configuration object with the following fields:
    *   `commitment` (string, optional): Specifies the commitment level to use for the query. Defaults to `finalized`. You can learn more about commitment levels in [this Helius blog post](https://www.helius.dev/blog/solana-commitment-levels).
