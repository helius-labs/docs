  ...
  <Tab title="RPC Proxy">
    ...
    <Steps>
      <Step title="Clone the Repository">
        ```bash
        git clone https://github.com/helius-labs/helius-rpc-proxy.git
        cd helius-rpc-proxy
        ```
      </Step>
      ...
      <Step title="Use Your Proxy">
        ```javascript
        // Use your deployed proxy URL
        const connection = new Connection('https://your-proxy.workers.dev');
        ```
      </Step>
    </Steps>
  </Tab>
...
<CardGroup cols={2}>
  ...
  <Card title="Security Best Practices" icon="shield-check" href="https://www.helius.dev/blog/security-best-practices">
    Read our comprehensive security guide
  </Card>
  <Card title="Enterprise Solutions" icon="building" href="https://form.typeform.com/to/KiacmxpZ">
    Discuss advanced security needs with our team
  </Card>
</CardGroup>
