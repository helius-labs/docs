...
<CardGroup cols={2}>
  ...
  <Card title="Production Ready" icon="shield">
    Built-in reconnection logic and error handling for reliable applications
  </Card>
...
<Tabs>
  <Tab title="Use WebSockets For">
    - **Trading applications** that need instant price updates
    - **Wallet applications** monitoring user account changes  
    - **DeFi dashboards** tracking liquidity pool changes
    - **NFT marketplaces** watching for new listings or sales
    - **Analytics platforms** processing real-time transaction data
  </Tab>
  <Tab title="Use HTTP For">
    - **One-time data fetches** like getting current balance
    - **Historical data queries** like transaction history
    - **Batch operations** like sending multiple transactions
    - **Simple integrations** that don't need real-time updates
    - **Rate-limited applications** with infrequent data needs
  </Tab>
</Tabs>
