---
title: "How to Get Solana Transactions: Complete Retrieval Guide"
sidebarTitle: "Get Transactions"
description: "Learn how to retrieve and parse Solana transactions using Helius RPC methods and Enhanced Transaction API. Single, batch, and status checking."
---
...
<Card title="API Reference" horizontal icon="code" href="/api-reference/rpc/http/gettransaction">
  getTransaction
</Card>
...
<Card title="API Reference" horizontal icon="code" href="/api-reference/rpc/http/getsignaturestatuses">
