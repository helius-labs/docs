---
title: "How to Get Solana Accounts: Complete RPC Guide"
sidebarTitle: "Get Accounts"
description: "Learn how to fetch Solana account data using Helius RPC methods. Get single accounts, multiple accounts, and batch retrieval with best practices."
---
...
<Card title="API Reference" horizontal icon="code" href="/api-reference/rpc/http/getaccountinfo">
  getAccountInfo
</Card>
...
<Card title="API Reference" horizontal icon="code" href="/api-reference/rpc/http/getmultipleaccounts">
  getMultipleAccounts
</Card>
