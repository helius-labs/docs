...
<Info>
**Beta Access Required**: Shred Delivery is currently in beta with white glove provisioning. Access is limited and requires approval from the Helius team. [Request beta access](#request-beta-access) below.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Validator Advantage" icon="star">
    Helius operates the highest staked validator on Solana, receiving shreds earliest from the network.
  </Card>
...
- **Choose Shred Delivery** when you need the absolute lowest latency access to raw transaction data and have the technical capability to process raw shreds
