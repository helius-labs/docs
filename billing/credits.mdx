...
description: "Complete guide to Helius credits including credit costs, how credits work, and credits for data streaming solutions."
---
 ...
 <table>
   ...
   <tbody>
     ...
     <tr>
       ...
       <td style={{textAlign: 'center'}}>100</td>
       <td>Enhanced transaction history with advanced filtering, sorting, and full transaction data.</td>
     </tr>
   </tbody>
 </table>
