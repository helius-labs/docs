...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>3</td>
      <td>Per 0.1MB of data - see examples below</td>
    </tr>
  </tbody>
</table>

#### LaserStream Examples

LaserStream costs **3 credits per 0.1MB** of data. Here are some real-world usage examples to help estimate your monthly costs:

**Service Limits**: LaserStream Professional plan supports up to 250k pubkeys and 100 active connections. Costs scale based on actual data volume consumed (3 credits per 0.1MB).

<table>
  <thead align="left">
    <tr>
      <th width="240">Stream Type</th>
      <th width="120">Data Rate</th>
      <th width="140">Monthly Credits</th>
      <th width="240">Use Case</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>8.5MB/s</td>
      <td>~660M credits</td>
      <td>Block-by-block transaction processing</td>
    </tr>
    <tr>
      <td><strong>Raydium Transactions</strong></td>
      <td>Variable</td>
      <td>~272M credits</td>
      <td>DEX trading activity monitoring</td>
    </tr>
    <tr>
      <td><strong>All Token Accounts</strong></td>
      <td>6KB/s</td>
      <td>~450K credits</td>
      <td>Token balance tracking</td>
    </tr>
  </tbody>
</table>

<Note>
**Estimation Note**: These are rough estimates based on typical network activity. Actual usage may vary depending on network congestion, specific filters, and time periods.
</Note>
