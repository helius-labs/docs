...
Here is a breakdown of the total number of credits that are included by default in each plan. If you need more credits, upgrade your plan, enable [autoscaling](/billing/autoscaling), purchase prepaid credits, or contact sales to discuss enterprise options.
...
### Data Add-ons
If you're on a Professional plan, you may purchase [Data Add-ons](/billing/plans#data-add-ons) between 5TB-100TB per month to be used for both Enhanced WebSockets and LaserStream. Overages will be billed at 3 credits per 0.1 MB.
