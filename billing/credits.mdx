...
**Service Limits**: LaserStream Professional plan supports up to 100k pubkeys and 100 active connections. Costs scale based on actual data volume consumed (3 credits per 0.1MB).
