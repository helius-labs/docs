...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Most RPC endpoints</td>
    </tr>
    <tr>
      <td><strong>simulateBundle</strong></td>
      <td style={{textAlign: 'center'}}>1</td>
      <td>Bundle simulation</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style={{textAlign: 'center'}}>1</td>
      <td>Per event sent by Helius (regardless of endpoint response)</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><strong>LaserStream Add-on</strong></td>
      <td style={{textAlign: 'center'}}>1</td>
