...
### LaserStream Plus Add-On

<Card title="LaserStream 50 TB Add-On" icon="bolt">
  ...
  **How it works:**
  ...
  - Add-on provides **50 TB included data** each month  
  - After your 50 TB runs out: Pay **2 credits per 0.1 MB** (33% cheaper than Professional plan's 3 credits)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><strong>LaserStream 50 TB Add-on</strong></td>
      <td style={{textAlign: 'center'}}>2</td>
      <td>Per 0.1 MB after 50 TB free (included with add-on)</td>
    </tr>
    <tr>
...
- **Professional Plan**: Pay 3 credits per 0.1 MB for all LaserStream usage.
- **LaserStream Plus Add-on**: Includes 50 TB monthly data. After that, pay only 2 credits per 0.1 MB (33% savings).
