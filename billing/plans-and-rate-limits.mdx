...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Enhanced transaction history with advanced filtering and sorting</td>
    </tr>
    <tr>
...
<Tabs>
  ...
  <Tab title="Transaction Submission">
    ...
    <Info>
     ...
     <Note>
     **getTransactionsForAddress costs 100 credits** per request due to its enhanced capabilities (advanced filtering, sorting, and full transaction data). See the main credit costs table above for details.
     </Note>
