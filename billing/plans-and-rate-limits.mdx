...
### LaserStream Plus Add-Ons

Transform your Professional plan's pay-per-use model into predictable costs with included monthly data allowances and reduced overage rates.
...
- **Professional Plan**: Pay 3 credits per 0.1 MB from the first byte
- **LaserStream Plus**: Fixed monthly cost + included data allowance + reduced overage rates
- All Professional plan features remain included with add-ons
</Note>
...
<Tabs>
  <Tab title="Transactions">
    ...
    <Note>
      **Need higher limits for sending transactions?** If you are on a Professional plan and need to increase your sendTransaction rate limits, [contact our sales team](https://form.typeform.com/to/KiacmxpZ). Professional plan users can also request significant rate limit upgrades for Sender to support high-throughput trading applications - [contact support](https://www.helius.dev/docs/support/contact-support) to discuss your specific use case's requirements.
    </Note>
  </Tab>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><strong>LaserStream Plus Add-on</strong></td>
      <td style={{textAlign: 'center'}}>2</td>
      <td>Per 0.1 MB after included data allowance (50TB, 100TB, 150TB, 200TB, or 250TB)</td>
    </tr>
    <tr>
