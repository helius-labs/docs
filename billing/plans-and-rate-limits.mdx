...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{textAlign: 'center'}}>10</td>
      <td>RPC calls that query historical blockchain data: <code>getTransaction</code>, <code>getSignaturesForAddress</code>, <code>getBlock</code>. For complete list, see <a href="#historical-data">Historical Data table</a> below</td>
    </tr>
    <tr>
...
<Tabs>
  ...
  <Tab title="Transaction Submission">
    ...
    <Info>
     ...
     <table>
       ...
       <tbody>
         <tr>
           ...
           <td>Retrieve block data and transactions for a confirmed block</td>
         </tr>
         <tr>
           <td><code>getBlocks</code></td>
           <td>Get list of confirmed blocks between two slots</td>
         </tr>
         <tr>
           <td><code>getBlocksWithLimit</code></td>
           <td>Get confirmed blocks starting at a given slot with limit</td>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <td>Retrieve transaction details for a confirmed transaction</td>
         </tr>
         <tr>
     ...
     <Note>
     **getSignatureStatuses pricing**: This method costs 10 credits only when the `searchTransactionHistory` parameter is set to `true` to search historical data. When `false` or omitted (searches only recent blocks), it costs 1 credit like other standard RPC calls.
     </Note>
   </Tab>
