...
<Card title="LaserStream 50TB Add-On" icon="bolt">
  ...
  **How it works:**
  ...
  - After your 50 TB runs out: Pay **2 credits per 0.1MB** (33% cheaper than Professional plan's 3 credits)
...
- **LaserStream Plus Add-on**: Includes 50 TB monthly bandwidth. After that, pay only 2 credit per 0.1MB (67% savings).
