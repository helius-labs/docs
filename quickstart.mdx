...
<Steps titleSize="h2"> 
  <Step title="Sign up for a Free Helius Account">
    Head over to the [Helius Dashboard](https://dashboard.helius.dev/dashboard) and create your free account.
  </Step>
  ...
  <Step title="Make Your First API Call">
    Paste your API key into the input field and click the button to fetch a random NFT from the owner address `86xCn…o2MMY` using the [getAssetsByOwner](/api-reference/das/getassetsbyowner) method.
    <Quickstart />
  </Step>
  <Step title="Success!">
