...
<Steps titleSize="h2"> 
  <Step title="Create Your Free Helius Account">
    Start by creating your free account at the [Helius Dashboard](https://dashboard.helius.dev/dashboard). Your free tier includes 100,000 API calls per month; perfect for getting started and building prototypes.
  </Step>
  ...
  <Step title="Understanding the Response">
    ...
    - **Compression**: Whether the NFT is compressed (cheaper to mint)
  </Step>
</Steps>
...
- **Add wallet connection**: Integrate with Phantom or Solflare wallets
