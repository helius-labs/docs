---
title: "Solana Dedicated Nodes Setup: Complete Getting Started Guide"
sidebarTitle: "Getting Started"
description: "Complete guide to setting up your Solana dedicated node with gRPC streaming, Yellowstone plugin, and optimal configuration for blockchain data."
---
...
<Frame caption="Select the Yellowstone gRPC Geyser Plugin (Recommended)">
  <img
    ...
    alt="Select the Yellowstone gRPC Geyser Plugin (Recommended)"
  />
</Frame>
