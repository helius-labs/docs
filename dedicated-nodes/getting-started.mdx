...
Once you have your Dedicated Node set up and ready (status: **Succeeded**), you can start working with it. For information about the dashboard and managing your node, see the [Dashboard](/solana-rpc-nodes/dedicated-nodes/dashboard) page.
